...
import { X, Star, ShoppingBag, Heart, CheckCircle, ShieldCheck } from 'lucide-react';
...
const QuickViewModal = ({ product, onClose }) => {
  ...
  // Compute selected price if variation selected
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full max-w-3xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row border border-slate-100 max-h-[90vh] overflow-y-auto">
        ...
        <div className="md:w-1/2 bg-slate-50 p-6 flex items-center justify-center">
          <img
            src={product.images && product.images[0] ? product.images[0] : '/images/products/placeholder.webp'}
            alt={product.name}
